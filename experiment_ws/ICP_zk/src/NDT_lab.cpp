...
main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("2.pcd", *input_cloud) == -1)
    {
    ...
    Eigen::Quaternionf q(0.0000, 0.0000, 0.0000, 0.0000);

    Eigen::AngleAxisf init_rotation(q);

    Eigen::Translation3f init_translation(0.0000, 0.0000, 0.0000);
    ...
    //保存转换的输入点云
    //pcl::io::savePCDFileASCII("lab_transformed.pcd", *output_cloud);
